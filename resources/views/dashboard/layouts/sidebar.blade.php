<div id="sideBar"
    class="relative flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 md:fixed
      md:top-0 md:z-30 md:h-screen md:shadow-xl animated faster">
    <!-- sidebar content -->
    <div class="flex flex-col">

        <!-- sidebar toggle
        <div class="text-right md:block mb-4">
        ...
        <p class="uppercase text-xs text-gray-600 mb-4 mt-4 tracking-wider">index</p>
        ...
        <a href="{{ route('dropshipper.index') }}"
            class="mb-3 capitalize font-medium text-sm hover:text-teal-600 transition ease-in-out duration-500">
            <i class="fa-solid fa-person text-x mr-2"></i>
            Dropshipper
        </a>
        <!-- end link -->
