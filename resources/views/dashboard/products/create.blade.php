                    ...
                    <div class="max-w-md mx-auto">
                        <div class="flex items-center space-x-5">
                            ...
                            <div class="block pl-2 font-semibold text-xl self-start text-gray-700">
                                <h2 class="leading-relaxed">Add New Product</h2>
                                <p class="text-sm text-gray-500 font-normal leading-relaxed">Add product and it will be
                                    list
                                    at your minishop</p>
                            </div>
                        </div>
                            ...
                            <form method="post" action="{{ route('products.store') }}">
                                <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input type="text"
                                            class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                            name="marketprice" placeholder="Price Market">
                                    </div>
                                    <div class="flex flex-col">
                                        <label class="leading-loose" for="dsprice">Dropship Price</label>
                                        <input type="text"
                                            class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                            name="dsprice" placeholder="Price Dropship">
                                    </div>
                                </div>
