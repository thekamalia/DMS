...
@section('container')
    ...
    <!-- congrats & summary -->
    <div class="grid grid-cols-3 lg:grid-cols-2 gap-5">
        <!-- congrats -->
        ...
        <div class="card col-span-1">
            <div class="card-body">
                ...
                <h1 class="capitalize text-lg mt-1 mb-1">$<span class="num-3"></span> <span
                        ...
                        orders</span></h1>
                <p class="capitalize text-xs text-gray-500">( $<span class="num-2"></span> in the
                    last year )</p>
            </div>
        </div>
        <!-- status -->
                ...
                <table class="table-fixed w-full">
                    ...
                    <thead class="text-left">
                        <tr>
                            ...
                            <th class="w-1/4 pb-10 text-sm font-extrabold tracking-wide text-right">Product
                            </th>
                            <th class="w-1/4 pb-10 text-sm font-extrabold tracking-wide text-right">Invoice
                            </th>
                    ...
                    <tbody class="text-left text-gray-600">
                        ...
                        <tr>
                            <!-- name -->
                            <th
                                class="w-1/2 mb-4 text-xs font-extrabold tracking-wider flex flex-row items-center">
                            ...
                            <!-- status -->
                            <th class="w-1/4 mb-4 text-xs font-extrabold tracking-wider text-right">shipped
                            </th>
                            <!-- status -->
