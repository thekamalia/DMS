    ...
    <div>
        ...
        <div class="cart-section container">
            <div>
                ...
                <h2> {{--{{ Cart::count() }} --}} item in Shopping Cart</h2>
                    ...
                    <div class="cart-table-row">
                        <div class="cart-table-row-left">
                            ...
                            <div class="cart-item-details">
                                <div class="cart-table-item"><a href="">sasa</a></div>
                                <div class="cart-table-description">sasasasas</div>
                            </div>
                        </div>
        ...
        {{-- </div><h2>{{ Cart::count() }} item(s) in Shopping Cart</h2> --}}
