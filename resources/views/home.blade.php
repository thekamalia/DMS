    ...
    <body data-spy="scroll" data-target=".fixed-top">
        ...
        <nav class="navbar fixed-top">
            <div class="container sm:px-4 lg:px-8 flex flex-wrap items-center justify-between lg:flex-nowrap">
                ...
                {{-- <a class="text-gray-800 font-semibold text-3xl leading-4 no-underline page-scroll" img class="h-64 w-64" src="assets/img/logo.png" alt="Workflow logo">DMS</a> --}}

                <!-- Image Logo -->
                <a class="inline-block mr-4 py-0.5 text-xl whitespace-nowrap hover:no-underline focus:no-underline" href="index.html">
                    <img src="/assets/img/logo2.png" alt="alternative" class="h-24" />
                </a>
        ...
        <header id="header" class="header py-28 text-center md:pt-36 lg:text-left xl:pt-44 xl:pb-32">
            <div class="container  lg:gap-x-8">
                <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                    <h1 class="h1-large mb-5">Manage your business easily</h1>
                    ...
                    <a class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Register as Seller</a>
                    <a class="btn-solid-lg secondary" href="login"><i class="fab fa-google-play"></i>Login</a>
                </div>
                <div class="xl:text-right">
                    <div class="mb-16 lg:mt-32 xl:mt-40 xl:mr-12">
                        <h1 class="h1-large mb-5">Manage your business easily</h1>
                        <p class="p-large mb-8">Start getting things done together with your team based on Pavo's revolutionary team management features</p>
                        <a class="btn-solid-lg" href="#your-link"><i class="fab fa-apple"></i>Register as Dropshipper</a>
                        <a class="btn-solid-lg secondary" href="/login"><i class="fab fa-google-play"></i>Login</a>
                    </div>
                </div>
            </div> <!-- end of container -->
        ...
        <div class="pt-4 pb-14 text-center">
            <div class="container px-4 sm:px-8 xl:px-4">
                <p class="mb-4 text-gray-800 text-3xl leading-10 lg:max-w-5xl lg:mx-auto">The Easiest And Most Automatic Online Business Management!</p>
            </div> <!-- end of container -->
        </div>
        <!-- end of introduction -->
            ...
            <div class="container px-4 sm:px-8 xl:px-4">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-1.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-2.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-3.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-4.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-5.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img src="/landingpage/images/features-icon-6.svg" alt="alternative" />
                    </div>
                    <div class="card-body">
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                <div class="lg:col-span-5">
                    <div class="mb-16 lg:mb-0 xl:mt-16">
                        <h2 class="mb-6">Trusted by Many, Believed by All</h2>
                ...
                <div class="lg:col-span-7">
                    <div class="xl:ml-14">
                        <img class="inline" src="/landingpage/images/details-1.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
            </div> <!-- end of container -->
        </div>
            ...
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
                <div class="lg:col-span-7">
                    <div class="mb-12 lg:mb-0 xl:mr-14">
                        <img class="inline" src="/landingpage/images/details-2.jpg" alt="alternative" />
                    </div>
                </div> <!-- end of col -->
                <div class="lg:col-span-5">
                    <div class="xl:mt-12">
        ...
        <div class="copyright">
            <div class="container px-4 sm:px-8 lg:grid lg:grid-cols-3">
                ...
                <p class="pb-2 p-small statement">Copyright © <a href="#your-link" class="no-underline">Dropshipping Management System</a></p>

                <p class="pb-2 p-small statement">Distributed by :<a href="https://themewagon.com/" class="no-underline">DMS</a></p>
            </div>
