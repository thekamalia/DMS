...
<body class>
    <div class="lg:flex">
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-pink-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <svg class="w-10 text-pink-500" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="text-2xl text-pink-800 tracking-wide ml-2 font-semibold">DMS</div>
                </div>
            </div>
            <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                <h2
                    class="text-center text-4xl text-pink-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">
                    Log in</h2>
                <div class="mt-12">
                    <form action="/login" method="post">
                        ...
                        <div>
                            ...
                            <input
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-pink-500 @error('email') is-invalid @enderror"
                                type="email" id="email" name="email" autofocus required value="{{ old('email') }}"
                        ...
                        <div class="mt-8">
                            <div class="flex justify-between items-center">
                                ...
                                <div>
                                    <a
                                        class="text-xs font-display font-semibold text-pink-600 hover:text-pink-800
                                        cursor-pointer">
                                        Forgot Password?
                                    </a>
                                </div>
                            ...
                            <input
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-pink-500"
                                type="password" name="password" id="password" placeholder="Enter your password">
                        </div>
                        <div class="mt-10">
                            <button
                                class="bg-pink-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Don't have an account ? <a class="cursor-pointer text-pink-600 hover:text-pink-800"
                            href="/register">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="hidden lg:flex items-center justify-center bg-pink-100 flex-1 h-screen">
